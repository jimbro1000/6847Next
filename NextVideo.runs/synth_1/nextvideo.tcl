...
synth_design -top nextvideo -part xc7a15tcsg325-3
...
write_checkpoint -force -noxdef nextvideo.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file nextvideo_utilization_synth.rpt -pb nextvideo_utilization_synth.pb"  } 
